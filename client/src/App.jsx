...
import FindLawyer from "./PublicPortal/fetch/FindLawyer";
import Records from "./PublicPortal/fetch/Records";
import AdminFile from "./pages/AddFiles";
  ...
  return (
    <main className="w-full min-h-screen bg-[#f3f4f6] ">
      <Routes>
        ...
        <Route path="/p-portal" element={<PublicPortal />} />
